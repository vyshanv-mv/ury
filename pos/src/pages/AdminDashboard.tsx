    ...
    <div className="flex flex-col h-screen bg-gray-50/50 font-inter text-gray-900 overflow-hidden selection:bg-blue-100 selection:text-blue-900">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <motion.aside
          ...
          className="bg-white border-r border-gray-200 flex-shrink-0 flex flex-col z-30 shadow-sm"
        >
                      ...
                      {NAV_ITEMS.filter((item) => item.group === group).map((item) => {
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "w-full flex items-center rounded-xl text-sm transition-all duration-200 relative group h-11",
                              isActive
          ...
          <div className="max-w-6xl mx-auto p-12 w-full">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {/* Actual Content */}
                <div className={cn(
                  activeSection !== "overview" ? "bg-white p-10 rounded-3xl border border-gray-200 shadow-xl shadow-gray-200/40" : ""
                )}>
