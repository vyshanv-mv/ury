    ...
    <div className="space-y-6">
      {loading ? (
        <div className="py-20 flex flex-col items-center justify-center space-y-4">
          ...
          <p className="text-sm font-medium text-gray-500">Scanning for printers...</p>
        </div>
      ) : (
        <>
          {/* Header Area */}
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50/50 border-b border-gray-100">
                    ...
                    <th className="px-6 py-4 text-xs font-medium text-gray-500">Printer Details</th>
                    <th className="px-6 py-4 text-xs font-medium text-gray-500">Network Address</th>
                      ...
                      paginatedPrinters.map((p, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <span className="px-2.5 py-1 bg-blue-50 text-blue-600 rounded-md text-[10px] font-medium border border-blue-100 inline-flex items-center gap-1.5">
                      ...
                      <tr>
                        <td colSpan={5} className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center gap-3">
                            ...
                            <div className="text-gray-400 text-sm font-medium">No printers configured</div>
          ...
          {/* Help Info */}
          <div className="p-6 bg-amber-50 rounded-md border border-amber-100 flex gap-4 items-center shadow-sm">
            <div className="w-12 h-12 bg-white rounded-md flex items-center justify-center flex-shrink-0 text-amber-600 shadow-sm border border-amber-100">
              <Hash className="w-6 h-6" />
            </div>
            <div>
              <h4 className="text-sm font-medium text-amber-900">Printer Connectivity</h4>
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-500 ml-1">Printer Name</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-500 ml-1">IP Address</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-500 ml-1">Port</label>
                    <div className="relative">
